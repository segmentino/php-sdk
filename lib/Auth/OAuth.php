 ...
 * @author      Segmentino.
 *
 * @link        https://segmentino.com
 *
 * @license     GNU/GPLv3 http://www.gnu.org/licenses/gpl-3.0.html
 */

namespace Segmentino\Auth;

use Segmentino\Exception\AuthorizationRequiredException;
use Segmentino\Exception\IncorrectParametersReturnedException;
...
class OAuth extends AbstractAuth
{
    ...
    /**
     * @param string $baseUrl URL of the Segmentino instance
    ...
    protected function getQueryParameters($isPost, $parameters)
    {
        ...
        if (isset($parameters['file'])) {
            // Segmentino's OAuth2 server does not recognize multipart forms so we have to append the access token as part of the URL
